...
const AboutUs = () => {
    return (
        <div style={{ display:'flex', flexDirection:'row'}}>
            ...
            <br></br>
            Un mariage, un anniversaire, un baby shower… ça se fête !
            <br></br>
            ...
            <br></br> exotique, guinguette... toujours dans la tendance du moment.
            <br></br>
            Des contenants pour vos cadeaux d’invités, à la décoration de table et de salle,
            <br></br>
            ou bien encore, l’organisation de votre évenement,
            <br></br>
            vous retrouverez l’essentiel pour une décoration parfaite qui vous ressemble.
            </p>
