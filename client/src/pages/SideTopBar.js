...
const SideTopBar = () => {
    ...
    <Navbar.Collapse id="basic-navbar-nav" style={{backgroundColor:"white", width:"1100px"}}>
    <Form style={{display:"flex", flexDirection:"row"}}>
        ...
        <Nav.Link href="#home" inline style={{display:"flex", flexDirection:"row"}}>
        ...
        <Nav.Link href="#link" style={{display:"flex", flexDirection:"row"}}>
