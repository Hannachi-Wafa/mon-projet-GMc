...
const user2Schema = new Schema({ 
  user2name: { type: String, required: true, unique: true }, 
  email: { type: String, required: true, unique: true },
  password: { type: String, required: true  },
  role: {
    type: String,
    enum: ['user2Normal', 'admin'],
    default: 'user2Normal'
  },
...
user2Schema.methods.validatePassword = function validatePassword(password) {// our own methods attached to our user model to validate if a password is correct at login.
...
module.exports = mongoose.model('User2', user2Schema) //exporting our models, with all its new methods and functiionality to be used in the user controller. see /controllers/user.js
